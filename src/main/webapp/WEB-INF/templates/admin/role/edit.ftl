		...
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<form class="form-horizontal" id="signupForm" action="update.html" method="post" >
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="radio-inline i-checks">
									<label>
										<input type="radio" <#if role.isSystem> checked="checked"</#if> value="true" name="isSystem">
										<i class="fa fa-check text-navy"></i>
									</label>
								</div>
								<div class="radio-inline i-checks">
									<label>
										<input type="radio" <#if !role.isSystem> checked="checked"</#if> value="false" name="isSystem">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<label class="checkbox-inline i-checks">
                                    <input type="checkbox" value="admin:admin" name="authorities" <#if role.authorities?seq_contains("admin:admin")> checked="checked"</#if> required />管理员管理
                                </label>
                                <label class="checkbox-inline i-checks">
                                    <input type="checkbox" value="admin:role" name="authorities" <#if role.authorities?seq_contains("admin:role")> checked="checked" </#if> />角色管理
                                </label>
							</div>
						</div>
