    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">
                                <span class="clear">
	                                ...
	                                <span class="text-muted text-xs block">${admin.department}</span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">Wechat Admin</div>
                    </li>
                   	<li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/admin/admin/list.html" data-index="0">推广计划</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/admin/role/list.html" data-index="0">推广定向</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/admin/admin/list.html" data-index="0">基本信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/admin/role/list.html" data-index="0">消费信息</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/admin/role/list.html" data-index="0">账户充值</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/admin/admin/list.html" data-index="0">投放报表</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="/admin/role/list.html" data-index="0">财务报表</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                                ...
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img class="img-circle" src="${base}/img/profile_small.jpg">
                                        </a>
            ...
            <div class="row content-tabs">
                ...
                <a href="logout.html" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i>退出</a>
            </div>
